...
with tab_overview:
    ...
    delivered_count = int(filtered.loc[filtered["Is Delivered"], col_client].count())
    ...
    with col_b:
        status_summary = (
            filtered.assign(__Status=filtered[col_status].fillna("Unknown").astype(str))
            .groupby("__Status")[col_client]
            .count()
            .reset_index(name="Orders")
