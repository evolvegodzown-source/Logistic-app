...
# ============================================================================
with tab_overview:
    # Calculated based on the count of non-null Client Name values
    ...
    render_kpis(
        [
            (
                ...
                "Count of non-null Client Name values in the selected filters.",
                "📦",
                BRAND["blue"],
            ),
            (
    ...
    with col_a:
        # Grouping by region and counting non-null Client Name records
        reg_summary = (
        ...
        if reg_summary.empty:
            ...
            fig = px.bar(
                ...
                orientation="h",
                text="Orders",
                title="Orders by Region / Hub (Client Name Count)",
    ...
    # Grouping weekly trend by counting non-null Client Name values
    trend = (
    ...
    if trend.empty:
        ...
        fig = px.line(
            ...
            y="Orders",
            markers=True,
            title="Dispensed Orders Over Time (Client Name Count)",
        )
        fig.update_traces(
            line_width=3,
            marker_size=8,
...
with tab_captains:
    ...
    if not col_captain:
        ...
        if cap_df.empty:
            ...
            # Aggregate Total_Orders using count of Client Name
            cap_summary = (
